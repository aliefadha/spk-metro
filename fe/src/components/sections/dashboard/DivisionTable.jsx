  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: error.response?.data?.message || 'Terjadi kesalahan saat menambahkan divisi.',
        timer: 2000,
      });
    }
  };
              ...
              <tr key={row.id} className="border-b">
                ...
                <td className="px-4 py-3">
                  <div className="flex space-x-4">
                    ...
                    <button className="p-1 hover:text-red-600" onClick={() => handleDelete(row.id)}><Trash2 className="w-5 h-5 text-red-500" /></button>
                  </div>
                </td>
              </tr>
            ))}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg w-96">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                <label className="block mb-2 text-sm font-medium">Nama Divisi</label>
                <input
                  type="text"
              ...
              <div className="flex justify-end space-x-4">
                ...
                <button type="submit" className="px-4 py-2 rounded-lg bg-primer text-white">
                  Simpan
                </button>
              </div>
            </form>
